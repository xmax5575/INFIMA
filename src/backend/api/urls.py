...
urlpatterns = [
    ...
    # Endpoint za dohvaćanje studentovih sažetaka
    ...
    # Endpoint za prikaz pitanja za admina
    path("admin/questions/", views.AdminQuestionsListView.as_view()),
    # Endpoint za prikaz recenzija za admina
